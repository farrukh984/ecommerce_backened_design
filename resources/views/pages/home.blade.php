...
<div class="inquiry-section" style="background-image: linear-gradient(rgba(0, 32, 70, 0.7), rgba(0, 32, 70, 0.7)), url('{{ asset('images/figma_home_contact_section.png') }}'); background-size: cover; background-position: center; border-radius: 8px; margin-top: 30px; padding: 40px 0;">
    <div class="container inquiry-flex">
        ...
        <div class="inquiry-form" style="background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
            ...
            <div class="form-group" style="margin-bottom: 12px;">
                <input type="text" placeholder="What item you need?" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #dee2e7; border-radius: 6px;">
            </div>
            <div class="form-group" style="margin-bottom: 12px;">
                <textarea placeholder="Type more details" rows="3" class="form-control" style="width: 100%; padding: 10px; border: 1px solid #dee2e7; border-radius: 6px;"></textarea>
            </div>

            <div class="form-row" style="display: flex; gap: 10px; margin-bottom: 20px;">
                <input type="number" placeholder="Quantity" class="form-control" style="flex: 1; padding: 10px; border: 1px solid #dee2e7; border-radius: 6px;">
                <select class="form-control" style="width: 80px; padding: 10px; border: 1px solid #dee2e7; border-radius: 6px;">
                    <option>Pcs</option>
                    <option>Kg</option>
                    <option>Sets</option>
                </select>
            ...
            <button class="btn-inquiry" style="width: 100%; background: #0d6efd; color: #fff; border: none; padding: 12px; border-radius: 6px; font-weight: 700; cursor: pointer;">Send inquiry</button>
        </div>
    </div>
</div>
