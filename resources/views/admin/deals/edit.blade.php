...
<div class="premium-card">
    <div class="action-header">
        <div class="header-title">
            <h2>Edit Deal: {{ $deal->title }}</h2>
            <p>Update the deal information and countdown timer</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.deals.update', $deal->id) }}">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                ...
                <div style="grid-column: span 2;">
                    ...
                    <textarea name="description" rows="3"
                              style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px; resize: vertical;">{{ old('description', $deal->description) }}</textarea>
                ...
                <div>
                    ...
                    <input type="number" name="discount_percent" value="{{ old('discount_percent', $deal->discount_percent) }}" min="1" max="99" required
                           style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px;">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="start_date" 
                           value="{{ old('start_date', $deal->start_date?->format('Y-m-d\TH:i')) }}" required
                           style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px;">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="end_date"
                           value="{{ old('end_date', $deal->end_date?->format('Y-m-d\TH:i')) }}" required
                           style="width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 12px; font-size: 14px;">
            ...
            <div style="margin-top: 32px; display: flex; gap: 16px;">
                <button type="submit" class="btn-primary" style="padding: 14px 32px;">
                    <i class="fa-solid fa-save"></i> Update Deal
                </button>
