                ...
                <tr>
                    ...
                    <td>
                        @if($category->background_image)
                            <img src="{{ display_image($category->background_image) }}" width="60" style="border-radius: 4px; border: 1px solid var(--admin-border, #eee);">
                        @else
                            <div style="width: 60px; height: 40px; background: var(--admin-card-alt, #eee); border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: var(--admin-text-sub, #999);">No Image</div>
                        @endif
                    </td>
